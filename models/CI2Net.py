...
class CI2Net(nn.Module):
    def __init__(self, channel=64):
        super(CI2Net, self).__init__()
        ...
        self.d4 = nn.Sequential(CIIM(64, num_groups=4, hidden_dim=32))
        self.d3 = nn.Sequential(CIIM(64, num_groups=4, hidden_dim=32))
        self.d2 = nn.Sequential(CIIM(64, num_groups=4, hidden_dim=32))
        self.d1 = nn.Sequential(CIIM(64, num_groups=4, hidden_dim=32))
...
if __name__ == '__main__':
    ...
    flops, params = profile(CI2Net(x), (x,))
